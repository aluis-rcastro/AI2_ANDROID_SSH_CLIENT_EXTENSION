...
public class ClientSSHAI2Ext extends AndroidNonvisibleComponent implements Component
{
     ...
     */
	@SimpleEvent
    public void NewDebugMessage(String data)
    {
        // invoke the application's "LastDebugMessage" event handler.
        EventDispatcher.dispatchEvent(this, "LastDebugMessage", data);
    }
     ...
     */
	@SimpleEvent
    public void NewIncomingMessage(String data)
    {
